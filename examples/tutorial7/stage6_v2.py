...
class stage6_v2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Stage6 V2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Stage6 V2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "stage6_v2")
...
def main(top_block_cls=stage6_v2, options=None):
