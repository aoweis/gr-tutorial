...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(sps, rrc_taps)
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.fir_filter_xxx_0, 0))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.channels_channel_model_0, 0))
