...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/ahmad/gr-tutorial/examples/tutorial7/received', True)
        ...
        self.bladeRF_source_0.set_sample_rate((samp_rate*sps))
        ...
        # Connections
        ##################################################
        self.connect((self.bladeRF_source_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
    ...
    def set_sps(self, sps):
        ...
        self.bladeRF_source_0.set_sample_rate((self.samp_rate*self.sps))
        self.qtgui_sink_x_0.set_frequency_range(self.rf_freq, (self.samp_rate*self.sps))
