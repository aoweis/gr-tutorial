...
class bpsk_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Bpsk Rx", catch_exceptions=True)
        ...
        self._rf_freq_range = Range(2479, 2481, .001, 2480, 200)
        ...
        self._rx_gain_range = Range(0, 30, .1, 1, 200)
        ...
        self.blocks_freqshift_cc_0 = blocks.rotator_cc(2.0*math.pi*(-250e3)/rf_samp_rate)
        ...
        self.bladeRF_source_0.set_center_freq((rf_freq * 1e6 - 250e3),0)
        self.bladeRF_source_0.set_bandwidth(rf_samp_rate,0)
        ...
        self.connect((self.analog_agc3_xx_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
        self.connect((self.analog_agc3_xx_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.analog_agc3_xx_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.bladeRF_source_0, 0), (self.blocks_freqshift_cc_0, 0))
        self.connect((self.bladeRF_source_0, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.blocks_char_to_float_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_char_to_float_0_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_freqshift_cc_0, 0), (self.analog_agc3_xx_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_probe_rate_0, 0))
    ...
    def set_rf_samp_rate(self, rf_samp_rate):
        ...
        self.bladeRF_source_0.set_bandwidth(self.rf_samp_rate, 0)
        self.blocks_freqshift_cc_0.set_phase_inc(2.0*math.pi*(-250e3)/self.rf_samp_rate)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.rf_samp_rate)
        self.qtgui_sink_x_0.set_frequency_range(self.rf_freq, self.rf_samp_rate)
        self.qtgui_time_sink_x_1_0.set_samp_rate(self.rf_samp_rate)
    ...
    def set_rf_freq(self, rf_freq):
        ...
        self.bladeRF_source_0.set_center_freq((self.rf_freq * 1e6 - 250e3), 0)
        self.qtgui_sink_x_0.set_frequency_range(self.rf_freq, self.rf_samp_rate)
